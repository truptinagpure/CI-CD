...
class Client
{
  ...
  public function __construct(array $config = array())
  {
    $this->config = array_merge(
        [
          ...
          'client_id' => '26970010818-533tml8k4v68488mk7cee7k7utu25cf9.apps.googleusercontent.com',
          'client_secret' => 'AreBFw_zl02rfOgDjagbj-KB',
  ...
  {
    // echo "in createAuthUrl function";
    // exit();
    if (empty($scope)) {

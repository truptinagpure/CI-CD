...
function mk_hnumber($name,$caption="",$value="",$options=''){
    ...
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10">
            <input class=" form-control" id="<?=$name?>" name="<?=$name?>" type="number" value="<?=$value?>" <?=$options?>/>
        </div>
    </div>
    <?php
}
...
function mk_htextarea($name,$caption="",$value="",$options='',$tooltipText=''){
    ?>
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10 tooltipText">
...
function mk_hWYSItexteditor($name,$caption="",$value="",$options=''){
    ?>
    <div class="form-group">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10">
...
function mk_hWYSItexteditor_v1($name, $caption="",$value="",$id=''){
    ?>
    <div class="form-group">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10">
            <textarea class="ckeditor form-control" id="<?php echo $id; ?>" name="<?=$name?>"><?=$value?></textarea>
        </div>
    </div>
    <?php
}

function mk_hWYSItexteditor_required($name, $caption="", $value="",$id=''){
    ?>
    <div class="form-group">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10">
            <textarea class="ckeditor form-control" id="<?php echo $id; ?>" name="<?=$name?>" data-error=".<?=$name?>error"><?=$value?></textarea>
            <div class="<?=$name?>error error_msg"><?php echo form_error($name, '<label class="error">', '</label>'); ?></div>
        </div>
    </div>
    <?php
}
...
function mk_hsubmit($submitCaption=null,$backURL=null,$backCaption=null){
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
            <input class="btn green" type="submit" value="<?=$submitCaption!=null?$submitCaption:''?>" >
...
function mk_hcheckbox_opt($name, $caption="", $checked=null, $value="1", $class='', $id=''){
    ?>
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10 col-sm-10">
            <input value="<?=$value?>" type="checkbox" onclick="if($(this).attr('checked')=='checked'){ $(this).next().removeAttr('checked'); }else{ $(this).next().attr('checked','checked'); }" style="width: 20px" class="checkbox form-control <?php echo $class; ?>" id="#<?=$id?>" name="<?=$name?>" <?=$checked!=null?"checked='checked'":""?>>
            <input value="<?=$value?>" type="checkbox" style="display: none;" class="#<?=$id?>1" id="#<?=$id?>1" name="<?=$name?>" <?=$checked==null?"checked='checked'":""?>>
        </div>
    </div>
    <?php
}
function mk_hpostcheckbox($name,$caption="",$checked=null,$value="1",$options=''){
    ?>
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10 col-sm-10">
...
function mk_hselect2($name,$caption="",$options_data=null,$field_id,$field_name,$value=null,$null_select=null,$options='',$onselect=null,$translate=null){
    ?>
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10 col-sm-10">
            <select class="form-control input-lg select2-multiple" id="select2-multiple-input-lg" name="<?=$name?>" <?=$options?> <?=$onselect!=null?"onchange='".$onselect."'":""?>>
                <?php if($null_select!=null){ ?>
...
function mk_hselectLocation($name,$caption="",$options_data=null,$field_id,$field_name,$value=null,$null_select=null,$options='',$onselect=null,$translate=null){
    // print_r($options_data['test'][0]);
    ?>
    <div class="form-group ">
        <label for="<?=$name?>" class="control-label col-lg-2"><?=$caption?></label>
        <div class="col-lg-10 col-sm-10">
            <select class="form-control" id="<?=$name?>" name="<?=$name?>" <?=$options?> <?=$onselect!=null?"onchange='".$onselect."'":""?>>
                ...
                <option value="0"><?=$null_select?></option>
                <?php } ?>
                <?php if($options_data!=null){ print_r($options_data);?>
                    <?php foreach($options_data as $data){ ?>
                    <option value="<?=$data?>" <?=($value!=null && $data==$value)?"selected":""?>><?=$translate!=null?_l($data,$translate):$data?></option>
                    <?php } ?>
                <?php } ?>
            </select>
        </div>

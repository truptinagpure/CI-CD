...
class Nacc_subcategory_model extends CI_Model
{
    ...
    function get_nacc_list($conditions=[])
    {
        ...
        $this->db->select('nc.*, eid.INST_NAME, ac.name as accreditation_name, sj.name as category_name');
        ...
        $this->db->where('nc.parent_id IN (SELECT id FROM nacc where parent_id = 0)', NULL, FALSE);

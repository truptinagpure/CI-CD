...
class Disclosure_subcategory_modal extends CI_Model
{
    ...
    function get_documents_category_list($conditions=[])
    {
        ...
        $this->db->join('mandatory_disclosure_category dd', 'dc.document_category_id = dd.id', 'left');
    ...
    function _insert($data) {
        ...
        $table                      = 'mandatory_disclosure_subcategory';

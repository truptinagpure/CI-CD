...
$banner_image_url         = $banner_default_image_url = base_url()."upload_file/banner_images/default.png";
$delete_image                = false;
    if(isset($banner_data['image']) && !empty($banner_data['image']))
    {
        $delete_image        = true;
        //$banner_image_url = base_url()."upload_file/banner_images/".$banner_data['image'];
        $banner_image_url = base_url().$banner_data['image']; // note: we save all img path because initially save all image path in table.
    }
    ...
    <div class="col-lg-10 col-sm-10">
        <div class="row"> 
            <div class="col-md-12">
                ...
                <?php if(isset($banner_data['image']) && !empty($banner_data['image'])){ ?>
                    <img id="croppie-image" class="croppie-img" src="<?php echo $banner_image_url; ?>" height="170px" width="170px" />
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div id="banner_image_demo"  style=""></div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $image_crop = $('#banner_image_demo').croppie({
            enableExif: true,
            viewport: {
                width: 621,
                height: 352,

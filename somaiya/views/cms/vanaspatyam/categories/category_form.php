    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                &nbsp;&nbsp;
                <span class="custpurple"><a class="sizebtn btn brown" href="<?php echo base_url('cms/plant_category/'); ?>">Back</a></span>
            </div>
                    ...
                    <form id="manage_form" class="cmxform form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/plant_category/') ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>

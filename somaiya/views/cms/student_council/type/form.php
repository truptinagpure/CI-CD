    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                &nbsp;&nbsp;
                <span class="custpurple"><a class="sizebtn btn brown" href="<?php echo base_url('cms/student_council_designation/'); ?>">Back</a></span>
            </div>
                ...
                <div class="form-body">
                    <form id="manage_form" class="cmxform form-horizontal tasi-form" method="post" action="">
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="designation" name="designation" value="<?php echo set_value('designation', (isset($post_data['designation']) ? $post_data['designation'] : '')); ?>" required data-error=".designationerror" maxlength="250">
                                <div class="designationerror error_msg"><?php echo form_error('designation', '<label class="error">', '</label>'); ?></div>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="status" class="control-label col-lg-2">Publish <span><a title="Click checkbox to display this awards type on live website or else it will be saved in CMS draft." data-toggle="tooltip" data-placement="right"><i class="fa fa-info-circle" aria-hidden="true"></i></a></span></label>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/student_council_designation/') ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>

    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                &nbsp;&nbsp;<span class="custpurple"><a class="brownsmall btn brown" href="<?php echo base_url('cms/nacc_subcategory/'); ?>">Back </a></span>
            </div>
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <form id="nacc_form" class="cmxform form-horizontal tasi-form" enctype='multipart/form-data' method="post" action="">
                        ...
                        ?>
                         <div class="form-group ">
                            <label for="parent_id" class="control-label col-lg-2">Category <span class="asterisk">*</span></label>
                            <div class="col-lg-10">

                                <select id="parent_id" class="form-control input-lg select2-multiple" name="parent_id[]" data-placeholder="Please select category" required>
                        ...
                        <?php $this->load->view('cms/nacc/nacc_subcategory/nacc_files'); ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/nacc_subcategory/') ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
...
// get result subcategory base on category
    ...
    $(document).on('change','#accreditation_id',function(e){
        ...
        //$(".loader").show();
        $.ajax({
            url : "<?php echo base_url(); ?>cms/nacc_subcategory/get_category_by_accreditation_id",
            type: "POST",
            ...
            success: function(data, textStatus, jqXHR)
            {
                ...
                $("#parent_id").html(categorylisthtml);
                //$(".loader").hide();
            },

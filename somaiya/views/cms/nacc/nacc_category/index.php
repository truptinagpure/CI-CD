            ...
            <div class="portlet light ">
                <div class="portlet-title tabbable-line">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject font-brown bold uppercase">Category - <?=$institute_name  ?>  (<?= $institute_short_name?>)</span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <span class="custorange">
                                    <a class="sizebtn btn sbold orange" href="<?php echo base_url(); ?>cms/nacc_category/edit/">Add New</a>
                                </span>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="wd100 text-center">
                                                    <a href="<?php echo base_url('cms/nacc_category/edit/'.$data["id"]); ?>" class="btn custblue btn-sm" title="<?=_l('Edit',$this)?>"><i title="<?=_l('Edit',$this)?>" class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0);" class="btn custred" title="<?=_l('Delete',$this)?>" onClick="confirmdelete('<?php echo base_url('cms/nacc_category/delete/'.$data["id"]); ?>');"><i title="<?=_l('Delete',$this)?>" class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                            <?php

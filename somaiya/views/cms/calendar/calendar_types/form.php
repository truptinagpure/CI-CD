            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <?php if(isset($id) && !empty($id)) { ?>
                        <span class="caption-subject font-brown bold uppercase">Edit Calendar Type</span>
                    <?php } else { ?>
                         <span class="caption-subject font-brown bold uppercase">Add New Calendar Type</span>
                   <?php } ?>
                </div>
                &nbsp;&nbsp;
                <span class="custpurple"><a class="sizebtn btn brown" href="<?php echo base_url('cms/calendar_types/'); ?>">Back</a></span>
            </div>
            <div class="portlet-body form">
                <div class="form-body">
                    <form id="manage_form" class="cmxform form-horizontal tasi-form" method="post" action="">
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">Calendar Type <span class="asterisk">*</span></label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group ">
                            <label for="color" class="control-label col-lg-2">Color <span class="asterisk">*</span></label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="color" name="color" value="<?php echo set_value('color', (isset($post_data['color']) ? $post_data['color'] : '')); ?>" required data-error=".colorerror" maxlength="250">
                                <div class="colorerror error_msg"><?php echo form_error('color', '<label class="error">', '</label>'); ?></div>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/calendar_types/') ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>

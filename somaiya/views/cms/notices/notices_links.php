<div class="form-group ">
    <label for="status" class="control-label col-lg-2">Notice URL</label>
...
$(document).on('click', 'a.add', function (e) {
    ...
    $(".removeMore"+i).click(function(){
        ...
        if(answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('cms/notices/delete_links');?>",
                data: "pid="+pid,
    ...
    $(document).ready(function()
    {
        $( "#page_list" ).sortable({
            ...
            update  : function(event, ui)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('cms/notices/save_noticelinks_order');?>",

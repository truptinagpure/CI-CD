...
<div class="form-group">
    <label class="control-label col-lg-2">Featured Image <span class="asterisk">*</span>&nbsp;&nbsp;<span><a title="" data-toggle="tooltip" data-placement="right" data-original-title="Upload image dimensions are 621 pixels (width) x 352 pixels (height). And size of file should be less than 2mb."><i class="fa fa-info-circle" aria-hidden="true"></i></a></span></label>
    <div class="col-lg-10 col-sm-10">
        <div class="row"> 
            <div class="col-md-12">
                ...
                <?php } else { ?>
                    <input id="croppie_upload_image" type="file" class="croppie-input cc" name="iamge1" placeholder="Photo" capture>
                <?php } ?>
        ...
        <div class="col-md-1">
            <?php if($delete_image){ ?>
                <a class="btn btn-sm btn-danger" id="delete_image" href="javascript:void(0);" title="Delete" onclick="delete_image('<?php echo $project_id; ?>');"><i class="icon-trash"></i></a>
            <?php } ?>
        </div>
...
<script type="text/javascript">
	...
	function delete_image(project_id) {
        ...
        if (answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('cms/projects/deletefeaimage');?>",

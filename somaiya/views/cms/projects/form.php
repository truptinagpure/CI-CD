            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <?php if(isset($project_id) && !empty($project_id)) { $projecttype=""; ?>
                            <span class="caption-subject font-brown bold uppercase">Edit Project</span>
                        <?php } else { $projecttype="checked"; ?>
                        ...
                        <form id="project_form" class="cmxform form-horizontal tasi-form" method="post" action="" enctype='multipart/form-data'>
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-4 col-sm-5">
                                         <label class="control-label " style="float: left;margin-right:10px;"> Research<span class="asterisk"></span></label>
                                       <input type='radio' style="width: 20px;height: 34px;float: left;" name='type' id="research" value="research"  <?php if(isset($post_data['type'])){if($post_data['type'] == 'research') echo"checked"; }else{ echo $projecttype; } ?> >
                                      
                                    </div>

                                    <div class="col-lg-4 col-sm-5">
                                         <label class="control-label " style="float: left;margin-right:10px;">Consultancy </label>
                                          <input type='radio'  style="width: 20px;height: 34px;float: left;" name='type' id="consultancy" value="consultancy"  <?php if(isset($post_data['type'])){if($post_data['type'] == 'consultancy') echo"checked"; }else{ } ?>>
                            ...
                            <div class="form-group consultancyhide" >
                                <label for="short_title" class="control-label col-lg-2"> Short Title</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="short_title" name="short_title" value="<?php echo set_value('short_title', (isset($post_data['short_title']) ? $post_data['short_title'] : '')); ?>" maxlength="250">
                                ...
                                <div class="col-lg-8 col-sm-10">
                                    ...
                                    <option value="">Select Area</option>
                                     ...
                                     <div class="areaerror error_msg"><?php echo form_error('area_id', '<label class="error">', '</label>'); ?></div>
                                       <input type="text" name ="area_name" id="area_name" value="" style="display:none" />
                                </div>
                            </div>
                            <?php if(isset($post_data['area_specialization'])){
                            $area_specialization=$post_data['area_specialization'];
                            }else{
                            $area_specialization="";
                            } ?>
                             <div class="form-group col-lg-6 ">
                                <label for="area_specialization" class="control-label col-lg-4 area-lbl">Area Specialization<span class="asterisk">*</span></label>
                                <div class="col-lg-8 col-sm-10">
                                    <select id="area_specialization" class="form-control select2" data-error=".area_spec_iderror" name="area_specialization" data-placeholder="Select Area Specialization" required>
                                    <option value="">Select Area Specialization</option>
                                        <!-- <?php if(isset($areasspecia) && count($areasspecia)!=0){ ?>
                                        <?php foreach ($areasspecia as $key4 => $data4) { ?>
                                            <option value="<?=$data4['area_id']?>" <?php if($post_data['area_id'] == $data4['area_id']) echo"selected"; ?>><?=$data4['name']?></option>
                                        <?php } } ?> -->
                                    </select>
                                     <div class="area_spec_iderror error_msg"><?php echo form_error('area_id', '<label class="error">', '</label>'); ?></div>
                        ...
                        <!--     <div class="form-group col-lg-6">
                         ...
                         <div class="form-group col-lg-6">
                                           ...
                                           <!--   <input type="text" id="datetimepicker2" name="date" value="<?php if(isset($post_data['date'])) { echo $post_data['date']; } ?>"  />  -->
                                             <input class="date-own form-control"  data-error=".dateserror"  name="date" value="<?php if(isset($post_data['date'])) { echo $post_data['date']; }else{ echo date('Y-m'); } ?>" style="width: 300px;    margin-top: -15px;" type="text" required>

                                              <div class="dateserror error_msg"><?php echo form_error('date', '<label class="error">', '</label>'); ?></div>
                                            </div>
                                             </div>

                                               <div class="form-group col-lg-6" style="display:none" id="end_date_div">
                                <label for="end_date" class="control-label col-lg-4">End Year and Month of the project  <span class="asterisk">*</span></label>
                                <div class="col-lg-8">
                                      <input class="date-own form-control"  data-error=".enddateserror" name="end_date" value="<?php if(isset($post_data['end_date'])) { echo $post_data['end_date']; }else{ echo date('Y-m'); } ?>" style="width: 300px;    margin-top: -15px;" type="text" >
                                      <div class="enddateserror error_msg"><?php echo form_error('end_date', '<label class="error">', '</label>'); ?></div>
                                </div>
                            </div>



                                              <div class="form-group col-lg-6 consultancyhide"  >
                                <label for="area_id" class="control-label col-lg-4 area-lbl">Category <span class="asterisk"></span></label>
                                <div class="col-lg-8 col-sm-10">
                                     <select id="single" class="form-control select2"  name="category_id" data-placeholder="Select Category" >
                            ...
                            <div class="form-group col-lg-6 consultancyhide" >
                                ...
                                <div class="col-lg-8 col-sm-12">
                                    <select id="project_level" class="form-control select2"  name="project_level" data-placeholder="Select Project Level" data-error=".project_levelerror">
...
<!-- 
 ...
 -->
                        ...
                        {
                            $selected_department_id = explode(',' , $post_data['department']);
                        }
                        ?>
                     ...
                     <!--            <label class="control-label col-lg-2">Featured Image <span class="asterisk">*</span></label>
                                        ...
                                        <div class="col-lg-12 col-sm-10">
                                            <div class="custom-file-upload">
                                                <input type="file" name="image" id="image" required>
                                                 <div data-error=".imageerror" class="imageerror error_msg"><?php echo form_error('image', '<label class="error">', '</label>'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="col-lg-12 ">
                                 <?php $this->load->view('cms/projects/Featured_image'); ?>
                                </div>
                            </div>
                            ...
                            <?php if(isset($data_image) && is_array($post_data) && count($post_data)): $i=1; ?>
                                ...
                                ?>   
                                <label class="control-label col-lg-2 consultancyhide">Uploaded Images</label>
                                <div class="col-lg-10 col-sm-10 row_position">
                                    <ul class="imagelocation<?php echo $data['id'] ?> gallerybg consultancyhide" id="sortable">
...
<!--       <label class="control-label col-lg-4"><b>Project Research Team :</b></label><br /> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4 col-sm-5">
                                         <label class="control-label " style="float: left;margin-right:10px;">External Users / Students </label>
                            ...
                            <div class="boxform" id="Existing_user_Box"  <?php if(isset($uservalueExisting) && count($uservalueExisting)!=0){ ?>style="display: block" <?php } else{ ?> style="display: none" <?php }?> >
                                ...
                                <table style="width: 100%;" class="research-teamtable" id="Teamuser_existing">
                                <?php if(isset($uservalueExisting) && count($uservalueExisting)!=0){ ?>
                                    ...
                                    <tr class="group_wrapexi">
                                            <td class="empid_td" style="display:none">
                                                <div class="p10">
                                            ...
                                            <td class="existingaboutemp_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">About Employee  </label>
                                                </div>
                                            </td>
                                           <td class="exitype_td">
                                                <div class="p10">
                                            ...
                                            <tr class="group_wrapexi">
                                                ...
                                                <td class="exiname_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleexiname<?php echo $key6; ?>" name="existing_name[]" value="<?php if(isset($data6['name'])) { echo $data6['name']; } ?>" Placeholder="Search by Faculty Name" onkeyup="searchkeywords(<?php echo $key6; ?>)">
                                                         <div id="suggesstion-box<?php echo $key6; ?>" class="suggesstion-box"></div>
                                                          <input type="text" id="singleexibscil<?php echo $key6; ?>" style="display:none" name="existing_bscil[]" value="<?php if(isset($data6['BSCIL_MEMBER_ID'])) { echo $data6['BSCIL_MEMBER_ID']; } ?>" Placeholder="BSCIL_MEMBER_ID">
                                                    </div>
                                                </td>
                                                 ...
                                                 <td class="existingaboutemp_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleexiabout<?php echo $key6; ?>" name="Existing_about[]" value="<?php if(isset($data6['about_employee'])) { echo $data6['about_employee']; } ?>" Placeholder="About Employee">
                                                      ...
                                                      <td class="Exitype_td">
                                                        <div class="p10">
                                                            ...
                                                            <select id="singleExitype<?php echo $key6; ?>" class=""  name="existing_type[]" data-placeholder="Select Team Type" data-error=".typeerror" required>
                                    ...
                                    <?php $in++;}} else { ?>
                                        ...
                                        <tr class="group_wrapexi">
                                            ...
                                            <td class="exiname_td">
                                                <div class="p10">
                                                    <input type="text" id="singleexiname0" name="existing_name[]" Placeholder="Search by Faculty Name" onkeyup="searchkeywords(0)">
                                                      <div id="suggesstion-box0" class="suggesstion-box"></div>
                                                     <input type="text" id="singleexibscil0" style="display:none" name="existing_bscil[]" Placeholder="bscil">
                                                </div>
                                            </td>
                                            <td class="existingInstitute_td">
                                                <div class="p10">
                                             ...
                                             <td class="existingaboutemp_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleexiabout0" name="Existing_about[]" Placeholder="About Employee">
                                                        
                                                    </div>
                                                </td>
                                              <td class="exitype_td">
                                                <div class="p10">
                                                    <select id="singleExitype0" class=""  required name="existing_type[]" data-placeholder="Select Team Type" data-error=".typeerror">
                                <option value="">Select Team Type</option>    
                                    ...
                                    ?>
                                     ...
                                     <tr class="group_wrapext">
                                            <td class="Extname_td">
                                             ...
                                             <td class="ExtInstname_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">Institute Name  </label>
                                                </div>
                                            </td>
                                             <td class="Extdesig_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">Designation  </label>
                                                </div>
                                            </td>
                                             <td class="Extaboutemp_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">About Employee  </label>
                                                </div>
                                            </td>
                                            ...
                                            <tr class="group_wrapext">
                                                <td class="extname_td">
                                                 ...
                                                 <td class="extname_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleExtInstname<?php echo $key7; ?>" name="ExtInstname[]" value="<?php if(isset($data7['department'])) { echo $data7['department']; } ?>" Placeholder="Institute Name" >
                                                    </div>
                                                </td>
                                                 <td class="extname_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleExtdesig<?php echo $key7; ?>" name="Extdesig[]" value="<?php if(isset($data7['designation'])) { echo $data7['designation']; } ?>" Placeholder="Designation" >
                                                    </div>
                                                </td>
                                                 <td class="extaboutemp_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleExtaboutemp<?php echo $key7; ?>" name="Extabout_emp[]" value="<?php if(isset($data7['about_employee'])) { echo $data7['about_employee']; } ?>" Placeholder="About Employee" >
                                                    </div>
                                                </td>
                                                <td class="exttype_td">
                                                    <div class="p10">

                                                         <select id="singleExttype<?php echo $key7; ?>" class=""  required name="external_type[]" data-placeholder="Select Team Type" data-error=".typeerror" required>
                                                                <option value="">Select Team Type</option>    
                                                ...
                                                <td class="extemail_td">
                                                    <div class="p10">
                                                       <input type="text" id="singleExtemail<?php echo $key7; ?>" name="external_email[]"  value="<?php if(isset($data7['email'])) { echo $data7['email']; } ?>" Placeholder="Email" >
                                                    </div>
                                                </td>
                                            ...
                                            <td class="Extname_td">
                                             ...
                                             <td class="ExtInstname_td">
                                                <div class="p10">
                                                    ...
                                                    <input type="text" id="singleExtInstname0" name="ExtInstname[]" Placeholder="Institute Name" >
                                                </div>
                                            </td>
                                             <td class="Extdesig_td">
                                                <div class="p10">

                                                    <input type="text" id="singleExtdesig0" name="Extdesig[]" Placeholder="Designation" >
                                                </div>
                                            </td>
                                            <td class="Extaboutemp_td">
                                                <div class="p10">

                                                    <input type="text" id="singleExtaboutemp0" name="Extabout_emp[]" Placeholder="About Employee" >
                                                </div>
                                            </td>
                                            <td class="Exttype_td">
                                                <div class="p10">
                                                    <select id="singleExttype0" class=""  name="external_type[]" required data-placeholder="Select Team Type" data-error=".typeerror" required>
                                <option value="">Select Team Type</option>    
                                 <!--  <?php if(isset($data['external_type'])){ ?>
                                    ...
                                    <option value="Co-Investigator">Co-Investigator</option>
                                     <option value="Student Team">Student Team</option>
                                            ...
                                            <td class="extemail_td">
                                                <div class="p10">
                                                    <input type="text" id="singleExtemail0"  name="external_email[]"  />
                                               </div>
                                            </td>
                                            <td class="add_remove_tdext">
                                                <div class="p10">
                            ...
                            <div class="form-group consultancyhide">
                                <div class="col-lg-12 col-sm-12">
                                    <label class="control-label col-lg-3"><b>Signature </b></label>
                                </div>
                            </div>
                            <div class="boxform consultancyhide" id="Signature_user_Box">
                                  <div class="dataerror error_msg"><label class="error" id="eidsigerror"></label></div>

                                <table style="width: 100%;" class="research-teamtable" id="Teamuser_signature">
                                <?php if(isset($usersignature) && count($usersignature)!=0){ ?>
                                    <input type="hidden" name="user_array_checksignature" value="2">
                                    <?php
                                       
                                        foreach ($usersignature as $key6 => $data6) { 
                                    ?>
                                        <tr class="group_wrapsig">
                                            <td class="empidsig_td" style="display:none">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">Somaiya Emp Id  </label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="sigInstitute_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">Institute Name  </label>
                                                </div>
                                            </td>

                                            <td class="sigdesignation_td">
                                                <div class="p10">
                                                   <label class="control-label col-lg-2">Designation  </label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="sigdate_td">
                                                <div class="p10">
                                                    <label class="control-label col-lg-2">Publish On  </label>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <tr class="group_wrapsig">
                                                ...
                                                <td class="empidsig_td" style="display:none">
                                                    <div class="p10">
                                                        <input type="text" id="signatureempid<?php echo $key6; ?>" onfocusout="checkempdatasig(this.id,<?php echo $key6; ?>)"  name="sigempid[]" value="<?php if(isset($data6['e_id'])) { echo $data6['e_id']; } ?>" Placeholder="Somaiya Emp Id">
                                                    </div>
                                                </td>
                                                ...
                                                <td class="signame_td">
                                                    <div class="p10">
                                                        <input type="text" id="signame<?php echo $key6; ?>" name="sig_name[]" value="<?php if(isset($data6['name'])) { echo $data6['name']; } ?>" Placeholder="Search by Faculty Name" onkeyup="searchkeywords_sig(<?php echo $key6; ?>)">
                                                         <div id="suggesstion-boxnew<?php echo $key6; ?>" class="suggesstion-box"></div>
                                                          <input type="text" id="sigbscil<?php echo $key6; ?>" style="display:none" name="sig_bscil[]" value="<?php if(isset($data6['BSCIL_MEMBER_ID'])) { echo $data6['BSCIL_MEMBER_ID']; } ?>" Placeholder="BSCIL_MEMBER_ID">
                                                    </div>
                                                </td>
                                               
                                                   <td class="sigInstitute_td">
                                                    <div class="p10">
                                                        <input type="text" id="sigInstituteid<?php echo $key6; ?>" name="Institute_name_id[]" style="display:none" value="<?php if(isset($data6['institute_id'])) { echo $data6['institute_id']; } ?>" Placeholder="Institute name">
                                                         <input type="text" id="sigInstitute<?php echo $key6; ?>" name="Signature_Institute[]" value="<?php if(isset($data6['INST_NAME'])) { echo $data6['INST_NAME']; } ?>" Placeholder="Institute name">
                                                    </div>
                                                </td>

                                                <td class="sigdesignation_td">
                                                    <div class="p10">
                                                       <input type="text" id="sigdesignation<?php echo $key6; ?>" name="Signature_designation[]" value="<?php if(isset($data6['designation'])) { echo $data6['designation']; } ?>" Placeholder="Designation" >
                                                    </div>
                                                </td>

                                                <td class="sigdate_td">
                                                    <div class="p10">
                                                       <input type="text" id="sigdate<?php echo $key6; ?>" name="Signature_date[]" value="<?php if(isset($data6['publish_on'])) { echo $data6['publish_on']; } ?>" Placeholder="Publish On" >
                                                    </div>
                                                </td>

                                                <!-- <td class="add_remove_tdsig">
                                                    <div class="p10">
                                                        <?php if($key6 == 0){ ?>
                                                            <a class="addsig" href="javascript:void(0);" title="Add"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                                        <?php }else{ ?>
                                                            <a class="removeMoresig" data-id="<?php echo $data6['prid'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                        <?php } ?>
                                                    </div>
                                                </td> -->

                                                <input type='hidden' name='idsig[]' value='<?php echo $data6['id'] ?>' />
                                            </tr>
                                    <?php $in++;}} else { ?>
                                        <input type="hidden" name="user_array_checksignature" value="1">
                                        ...
                                        <tr class="group_wrapsig">
                                            ...
                                            <td class="sigdate_td">
                                                <div class="p10">
                                                    <label class="control-label col-lg-2">Published On  </label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="group_wrapsig">
                                            <td class="empidsig_td" style="display:none">
                                                <div class="p10">
                                                    ...
                                                    <input type="text" onfocusout="checkempdatasig(this.id,0)" id="signatureempid0" name="sigempid[]" Placeholder="smomaiya Employee Id">
                                                </div>
                                            </td>
                                            <td class="signame_td">
                                                <div class="p10">
                                                    <input type="text" id="signame0" name="sig_name[]" Placeholder="Search by Faculty Name" onkeyup="searchkeywords_sig(0)">
                                                      <div id="suggesstion-boxnew0" class="suggesstion-box"></div>
                                                     <input type="text" id="sig_bscil0" style="display:none" name="sig_bscil[]" Placeholder="bscil">
                                                </div>
                                            </td>
                                            <td class="sigInstitute_td">
                                                <div class="p10">
                                                      <input type="text" id="sigInstituteid0"  style="display:none" name="Institute_name_id[]" Placeholder="Institute name">
                                                       <input type="text" id="sigInstitute0" name="Signature_Institute[]" Placeholder="Institute name">
                                                </div>
                                            </td>

                                            <td class="sigdesignation">
                                                <div class="p10">
                                                       <input type="text" id="sigdesignation0" name="Signature_designation[]" Placeholder="Designation">
                                                </div>
                                            </td>

                                            <td class="sigdate_td">
                                                <div class="p10">
                                                    <input type="text" class="" id="sigdate0" name="Signature_date[]"  />
                                               </div>
                                            </td>
                           ...
                           <!--  <div class="form-group">
                            ...
                            <div class="form-group consultancyhide" >
                                <label for="pdf_path" class="control-label col-lg-2">PDF Path <span class="asterisk"></span></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="pdf_path" name="pdf_path" value="<?php echo set_value('pdf_path', (isset($post_data['pdf_path']) ? $post_data['pdf_path'] : '')); ?>"   >
                                <!--             <div class="durationerror error_msg"><?php echo form_error('duration', '<label class="error">', '</label>'); ?></div> -->
                                </div>
                            </div>
                             <div class="form-group consultancyshow" >
                                <label for="consultancy_offered_by" class="control-label col-lg-2">Consultancy offered by <span class="asterisk"></span></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="consultancy_offered_by" name="consultancy_offered_by" value="<?php echo set_value('consultancy_offered_by', (isset($post_data['consultancy_offered_by']) ? $post_data['consultancy_offered_by'] : '')); ?>"   >
                                <!--             <div class="durationerror error_msg"><?php echo form_error('duration', '<label class="error">', '</label>'); ?></div> -->
                                </div>
                            </div>
                            <div class="form-group consultancyhide " >
...
function deletedocument(image_id)
   ...
   var specialization= "<?php echo $area_specialization; ?>";
             $.ajax({
            type: "POST",
            url: "<?php echo site_url('cms/projects/get_area_Specialization');?>",
     ...
     success: function(data){
         var obj = $.parseJSON(data);
                    ...
                    if(obj.length > 0 )
                    {
                        ...
                        var Area_Specialization = '<option value="">Please select Area Specialization</option>';
                        $.each( obj, function( key, value ) {
                            if(value['id'] == specialization )
                            {
                                Area_Specialization += '<option value="'+value['id']+'" selected>'+value['specialization']+'</option>';
                            }
                            else
                            {
                                Area_Specialization += '<option value="'+value['id']+'">'+value['specialization']+'</option>';
                            }
                        ...
                        $("#area_specialization").html(Area_Specialization);
...
function searchkeywords(index)
{
    $('#singleempid'+index).val('');
    $('#singleExiemail'+index).val('');
    $('#singleExitype'+index).val('');


  
    var keywords = $("#singleexiname"+index).val();
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('cms/Projects/GetFacultyNameAutocomplete');?>",
        data:'keyword='+keywords+'&index='+index,
        beforeSend: function(){
...
function searchkeywords_sig(index)
{
    $('#signatureempid'+index).val('');

    var keywords = $("#signame"+index).val();
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('cms/Projects/GetFacultyNameAutocompletesignature');?>",
        data:'keyword='+keywords+'&index='+index,
        beforeSend: function(){
            $("#search-boxnew").css("background","#FFF url(LoaderIcon.gif) no-repeat 165px");
        },
        success: function(data){
            $("#suggesstion-boxnew"+index).show();
            $("#suggesstion-boxnew"+index).html(data);
            $("#search-boxnew").css("background","#FFF");
        }
        });
}
...
function selectFaculty(val,index) {



    $("#suggesstion-box"+index).hide();
    
    $.ajax({
            type: "POST",
            url: "<?php echo site_url('cms/projects/get_faculty_data');?>",
            data: {empid: val},
           dataType: 'json',
     success: function(response){
        var len = response.length;
        var email = response[0].EMAIL_ID;
        ...
        var BSCIL_MEMBER_ID =response[0].BSCIL_MEMBER_ID
        var INST_ID =response[0].INST_ID
        var INST_NAME =response[0].INST_NAME
        $('#singleempid'+index).val(MEMBER_ID);
        $('#singleexiname'+index).val(name);
        $('#singleExiemail'+index).val(email);
        $('#singleexiInstitute'+index).val(INST_ID);
        $('#singleexiInstituten'+index).val(INST_NAME);
        $('#singleexibscil'+index).val(BSCIL_MEMBER_ID);
     }
    });

}

function selectFacultysignature(val,index) 
{
    $("#suggesstion-boxnew"+index).hide();
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('cms/projects/get_faculty_data');?>",
        data: {empid: val},
        ...
        success: function(response){
            ...
            var INST_ID =response[0].INST_ID
            var INST_NAME =response[0].INST_NAME
            var HR_POSITION_NAME =response[0].HR_POSITION_NAME
            $('#signatureempid'+index).val(MEMBER_ID);
            $('#signame'+index).val(name);
            $('#sigInstituteid'+index).val(INST_ID);
            $('#sigInstitute'+index).val(INST_NAME);
            $('#sigbscil'+index).val(BSCIL_MEMBER_ID);
            $('#sigdesignation'+index).val(HR_POSITION_NAME);
        }
    });
}
...
$(document).on('click', 'a.add', function (e) {
    ...
    $(".removeMore"+i).click(function(){
        ...
        if(answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('cms/projects/deletedonor');?>",
                data: "pid="+pid,
                success: function (response) {
                  if (response == 1) {
...
$(document).on('click', 'a.addext', function (e) {
    e.preventDefault();
    $(".group_wrapext:last").after('<tr class="group_wrapext"> <td class="Extname_td"><div class="p10"> <input type="text" id="singleExtname'+i+'" name="Extname[]" Placeholder="Name"></div></td><td class="ExtInstname_td"><div class="p10"> <input type="text" id="singleExtInstname'+i+'" name="ExtInstname[]" Placeholder="Institute Name"></div></td><td class="Extdesig_td"><div class="p10"> <input type="text" id="singleExtdesig'+i+'" name="Extdesig[]" Placeholder="Designation"></div></td><td class="Extabout_td"><div class="p10"> <input type="text" id="singleExtaboutemp'+i+'" name="Extabout_emp[]" Placeholder="About Employee"></div></td><td class="Exttype_td"><div class="p10"><select id="singleExttype'+i+'" required class=""  name="external_type[]" data-placeholder="Select Team Type" data-error=".typeerror"><option value="">Select Team Type</option> <option value="Principal Investigator">Principal Investigator</option><option value="Co-Investigator">Co-Investigator</option>  <option value="Student Team">Student Team</option></select></div></td><td class="extemail_td"><div class="p10"><input type="text"  name="external_email[]" id="singleExtemail'+i+'"  /></div></td><td class="add_remove_tdext"><div class="p10"><a class="removeMoreext'+i+'" data-id="'+i+'"><i title="<?=_l("Delete",$this)?>" class="fa fa-trash-o"></i></a></div></td></tr>');
    // removeMore();
    $(".removeMoreext"+i).click(function(){
        ...
        if(answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('cms/projects/deleteExternal');?>",
                data: "pid="+pid,
                success: function (response) {
                  if (response == 1) {
                   // $(".imagelocation"+pid).remove(".imagelocation"+pid);
...
$(document).on('click', 'a.addexi', function (e) {
    e.preventDefault();
     var tablerowCount = $('#Teamuser_existing tr').length;
            //console.log("table row = "+ tablerowCount);
            var i = tablerowCount - 1;
    $(".group_wrapexi:last").after('<tr class="group_wrapexi"><td class="empid_td" style="display:none"><div class="p10"> <input type="text" id="singleempid'+i+'" onfocusout="checkempdata(this.id,'+i+')" name="empid[]" Placeholder="smomaiya Emp Id"></div></td><td class="exiname_td"><div class="p10"> <input type="text" id="singleexiname'+i+'" name="existing_name[]" Placeholder="Search by Faculty Name" onkeyup="searchkeywords('+i+')"> <div id="suggesstion-box'+i+'" class="suggesstion-box"></div><input type="text" id="singleexibscil'+i+'" style="display:none" name="existing_bscil[]" Placeholder="bscil"></div></td><td class="existingInstitute_td"><div class="p10"><input type="text" name="Institute_name[]" id="singleexiInstitute'+i+'" style="display:none" ><input type="text" name="Institute_namen[]" id="singleexiInstituten'+i+'" ></div></td><td class="exiaboutemp_td"><div class="p10"> <input type="text" id="singleExiaboutemp'+i+'" name="Existing_about[]" Placeholder="About employee"></div></td><td class="exitype_td"><div class="p10"><select id="singleExitype'+i+'" required class=""  name="existing_type[]" data-placeholder="Select Team Type" data-error=".typeerror"><option value="">Select Team Type</option> <option value="Principal Investigator">Principal Investigator</option><option value="Co-Investigator">Co-Investigator</option> </select></div></td><td class="exiemail_td"><div class="p10"> <input type="text" id="singleExiemail'+i+'" name="Existing_email[]"  Placeholder="Email"></div></td><td class="add_remove_tdexi"><div class="p10"><a class="removeMoreexi'+i+'" data-id="'+i+'"><i title="<?=_l("Delete",$this)?>" class="fa fa-trash-o"></i></a></div></td></tr>');
    // removeMore();
    $(".removeMoreexi"+i).click(function(){
        ...
        if(answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('cms/projects/deleteExisting');?>",
                data: "pid="+pid,
                success: function (response) {
                  if (response == 1) {
                   // $(".imagelocation"+pid).remove(".imagelocation"+pid);
...
var checkempdata;
 function typechange() {
    var type = $("input[name='type']:checked").val();
     if (type == 'consultancy') {
        $('.consultancyhide').hide(); // hides
        $('.consultancyshow').show(); // Shows
        
    }
    else if (type== 'research') {
         $('.consultancyhide').show(); // Shows 
         $('.consultancyshow').hide(); // hides
    }
}
 ...
 $(document).ready(function() {
         //   strat here
    typechange();    
    $('input[type=radio][name=type]').change(typechange);



 area_namechange(); //this calls it on load
$("#area_id").change(area_namechange);
$('#area_id').trigger('change');
function area_namechange() {
    var area_name=$( "#area_id option:selected" ).text();
    $( "#area_name" ).val(area_name);
}


 display_end_date(); //this calls it on load
$("#project_status").change(display_end_date);
...
if (empid === '' || empid ===null){
  ...
  $.ajax({
            type: "POST",
            url: "<?php echo site_url('cms/projects/get_employee_data');?>",
            data: {empid: empid},
           dataType: 'json',
     success: function(response){
       var len = response.length;
        ...
        $("#project_form").validate({
            ...
            messages: {
                ...
                date: {
                    ...
                    required: 'Please select Area Specialization ',
                },/*
                project_level:{
...
<script type="text/javascript">
    // var tablerowCount = $('#Teamuser_signature tr').length;
    // var i = 0;
    $('#sigdate0').datetimepicker({
        format:'Y-m-d H:i',
        //minDate:new Date()
    });
    $('#sigdate1').datetimepicker({
        format:'Y-m-d H:i',
        //minDate:new Date()
    });
    // i++;

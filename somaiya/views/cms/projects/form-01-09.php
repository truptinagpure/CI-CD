                                    ...
                                    <tr class="group_wrapexi">
                                           ...
                                           <td class="exitype_td">
                                            ...
                                            <tr class="group_wrapexi">
                                                ...
                                                <td class="Exiemail_td">
                                                    <div class="p10">
                                                       <input type="text" id="singleExiemail<?php echo $key6; ?>" name="Existing_email[]" value="<?php if(isset($data6['email'])) { echo $data6['email']; } ?>" Placeholder="Email" required>
                                                    </div>
                                                </td>
                                ...
                                <option value="">Select Team Type</option>    
                                  <?php if(isset($data['existing_type'])){ ?>
                                    ...
                                    <option value="Co-Investigator">Co-Investigator</option>
                                            ...
                                            <td class="exiemail_td">
                                                <div class="p10">
                                                    <input type="text" id="singleExiemail0" name="Existing_email[]" required="required" />
                                               </div>
                                            </td>
                                        ...
                                        <tr class="group_wrapext">
                                            ...
                                            <td class="Extaboutemp_td">
                                                <div class="p10">
                                                    ...
                                                    <input type="text" id="singleExtaboutemp0" name="Extabout_emp[]" Placeholder="About Employee" required>
                                                </div>
                                            </td>
                                            <td class="Exttype_td">
                                                <div class="p10">
...
$(document).on('click', 'a.addext', function (e) {
    e.preventDefault();
    $(".group_wrapext:last").after('<tr class="group_wrapext"> <td class="Extname_td"><div class="p10"> <input type="text" id="singleExtname'+i+'" name="Extname[]" Placeholder="Name"></div></td><td class="Extabout_td"><div class="p10"> <input type="text" id="singleExtaboutemp'+i+'" name="Extabout_emp[]" Placeholder="About Employee"></div></td><td class="Exttype_td"><div class="p10"><select id="singleExttype'+i+'" required class=""  name="external_type[]" data-placeholder="Select Team Type" data-error=".typeerror"><option value="">Select Team Type</option> <option value="Principal Investigator">Principal Investigator</option><option value="Co-Investigator">Co-Investigator</option> </select></div></td><td class="extemail_td"><div class="p10"><input type="text"  name="external_email[]" id="singleExtemail'+i+'" required /></div></td><td class="add_remove_tdext"><div class="p10"><a class="removeMoreext'+i+'" data-id="'+i+'"><i title="<?=_l("Delete",$this)?>" class="fa fa-trash-o"></i></a></div></td></tr>');
    // removeMore();

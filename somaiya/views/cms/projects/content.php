                ...
                <div class="portlet light ">
                    <div class="portlet-title tabbable-line">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject font-brown bold uppercase">Project Content</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <span class="custorange">
                                        <a href="<?php echo base_url('cms/projects/manage'.$page.'/'.$project_id); ?>">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="table_id">
                            ...
                            <tbody>
                                            ...
                                            <tr class="gradeX table_tr">
                                                ...
                                                <td>
                                                    <div class="wd100 text-center">
                                                        <a href="<?php echo base_url('cms/projects/manage'.$page.'/'.$project_id.'/'.$data["project_content_id"]); ?>" class="btn btn_bg_custblue" title="<?=_l('Edit',$this)?>"><i title="<?=_l('Edit',$this)?>" class="fa fa-pencil"></i></a>

                                                        <a href="javascript:void(0);" class="btn btn_bg_custred" title="<?=_l('Delete',$this)?>" onClick="confirmdeletecontent('<?php echo base_url('cms/projects/delete'.$page.'/'.$project_id.'/'.$data["project_content_id"].'/'.$data["language_id"]); ?>', '<?php echo $data["language_id"]; ?>');"><i title="<?=_l('Delete',$this)?>" class="fa fa-trash-o"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                <?php
                                ...
                                ?>
                                        <tr class="gradeX">
                                            <td class="text-center" colspan="6">No Project Content Available</td>
                                        </tr>
                                <?php } ?>
                            </tbody>
                        </table>

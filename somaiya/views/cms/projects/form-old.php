            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                       ...
                       <?php } ?>                    </div>      
                    &nbsp;&nbsp;<span class="custpurple"><a class="brownsmall btn brown" href="<?php echo base_url('cms/projects/index/'.$institute); ?>">Back </a></span>
                    ...
                    <div class="form-body">
                        <form id="project_form" class="cmxform form-horizontal tasi-form" method="post" action="" enctype='multipart/form-data'>
                            ...
                            <div class="form-group col-lg-6">
                                <label for="area_id" class="control-label col-lg-4 area-lbl">Area <span class="asterisk">*</span></label>
                                <div class="col-lg-8 col-sm-10">
                                    <select id="area_id" class="form-control select2" name="area_id" data-placeholder="Select Area" required>
                     ...
                     <div class="form-group col-lg-6">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="col-lg-8 col-sm-12">
                                    <select id="project_level" class="form-control select2" required name="project_level" data-placeholder="Select Project Level" data-error=".typeerror">
                                ...
                                <div class="typeerror error_msg"><?php echo form_error('project_level', '<label class="error">', '</label>'); ?></div>
                                </div>
                            </div>
                      <div class="form-group ">
                             ...
                             <div class="form-group">
                            <label for="projects_level" class="control-label col-lg-2"> Tags <span class="asterisk">*</span></label>
                            <div class="col-lg-10 col-sm-10">
                                ...
                                ?>
                                    <ul class="imagelocation<?php echo $data['id'] ?> gallerybg" id="sortable">
                                        <li style="list-style: none;" data-id="<?php echo $data['id'] ?>">
                                            ...
                                            <?php } ?>
                                            <a href="javascript:void(0);" class="btn btn_bg_custred height200btn" title="<?=_l('Delete',$this)?>" onClick="confirmdelete('<?php echo base_url('projects/deleteimage/'.$data["id"].'?area_id='.$data["area_id"]); ?>');">X</a>
                                        </li>
                                    </ul>
                                <?php } ?>
                                </div>
...
<!--       <label class="control-label col-lg-4"><b>Project Research Team :</b></label><br /> -->
                            ...
                            <div class="boxform" id="External_user_Box" <?php if(isset($uservalueExisting) && count($uservalueExisting)!=0){ ?>style="display: block" <?php } else{ ?> style="display: none" <?php }?>  >
                                <table style="width: 100%;" class="research-teamtable">
                                    ...
                                    ?>
                                     ...
                                     <tr class="group_wrapext">
                                            ...
                                            <tr class="group_wrapext">
                                                <td class="extname_td">
                                                    <div class="p10">
                                                        <input type="text" id="singleExtname<?php echo $key7; ?>" name="Extname[]" value="<?php if(isset($data7['name'])) { echo $data7['name']; } ?>" Placeholder="Name">
                                                    </div>
                                                </td>
                                                <td class="exttype_td">
                                                    <div class="p10">

                                                         <select id="singleExttype<?php echo $key7; ?>" class=""  name="external_type[]" data-placeholder="Select Team Type" data-error=".typeerror">
                                                                <option value="">Select Team Type</option>    
                                        ...
                                        <tr class="group_wrapext">
                                            <td class="Extname_td">
                                                <div class="p10">
                                                    ...
                                                    <input type="text" id="singleExtname0" name="Extname[]" Placeholder="Name">
                                                </div>
                                            </td>
                                            <td class="Exttype_td">
                                                <div class="p10">
                                                    <select id="singleExttype0" class=""  name="external_type[]" data-placeholder="Select Team Type" data-error=".typeerror">
                                <option value="">Select Team Type</option>    

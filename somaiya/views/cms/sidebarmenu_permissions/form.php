    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                &nbsp;&nbsp;<span class="custpurple"><a class="brownsmall btn brown" href="<?php echo base_url('cms/sidebarmenu_permissions/index'); ?>">Back</a> </span>
            </div>
                    ...
                    <form id="permissions_form" class="cmxform form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 col-sm-12" id="page_permissions_table">
                                <?php echo 'Loading.......';//$this->load->view('permissions/page_permissions_table', $this); ?> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/sidebarmenu_permissions/index'); ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
...
$("#pr_inst_id").val(pr_id);
    ...
    function get_menu_table(pr_id) {

   $('#page_permissions_table').html("Loading......");
        if(pr_id != '')
        {
            $.ajax({
                    type: "POST",
                    url: base_url+"cms/sidebarmenu_permissions/get_menu_table",
                    data: { pr_id : pr_id},
                    // beforeSend: function() {
                    //     $('.loader_bg').show();
                    // },
...
//console.log(<?php echo $pr_id; ?>);
    get_menu_table('<?php echo $pr_id; ?>');
</script>
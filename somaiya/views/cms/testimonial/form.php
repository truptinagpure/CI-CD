            ...
            <div class="portlet-body form">
                <div class="form-body">
                    ...
                    <?php  if( $institute == 32){?>
                        ...
                        <div class="form-group ">
                            <label for="batch" class="control-label col-lg-2">Designation </label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="designation" name="designation" value="<?php echo set_value('designation', (isset($data['designation']) ? $data['designation'] : '')); ?>"  maxlength="250">
...
if(isset($data['image']) && !empty($data['image'])){?>
    ...
    <div class="form-group">  <label class="control-label col-lg-2">uploaded Image  <span class="asterisk"></span></label>
                                   
                                    <div class="col-lg-10 col-sm-10">
 <input type="text" style="display: none" class="uploadImage-group  upload_image" id="upload_image" name="upload_image" size="33" value="<?php echo $data['image']; ?>"/>
    <?php
                                    ...
                                    ?>
                                        <ul class="imagelocation<?php echo $data['id'] ?> gallerybg" id="sortable">
                                            <li id="item-<?php echo $data['id'] ?>">
                                                <img class="" src="<?php echo base_url(); ?>upload_file/kjsieit/testimonial/<?php echo $data['image']; ?>" style="vertical-align:middle;" width="80" height="80">
...
?>
 ...
 <div class="form-group ">
                       ...
                       <label class="control-label col-lg-2">upload Image  <span class="asterisk"></span></label>

<div class="col-lg-10 col-sm-10">
                                 <input type="file"  class="uploadImage-group upload_image" id="upload_image" name="upload_image" size="33" />
                            </div>      
                        </div>
...
<!--  <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control uploadImage-group" id="video_url" name="video_url" value="<?php echo set_value('video_url', (isset($data['video_url']) ? $data['video_url'] : '')); ?>"  data-error=".video_urlerror" maxlength="250" >
                                <div class="video_urlerror error_msg"><?php echo form_error('video_url', '<label class="error">', '</label>'); ?></div>
                            </div>
                        </div> -->
                        (OR) <span><a title="Either you can upload image/video  or enter a embed code for youtube video" data-toggle="tooltip" data-placement="right"><i class="fa fa-info-circle" aria-hidden="true"></i></a></span>
  <div class="form-group ">
                            <label for="embed_code" class="control-label col-lg-2">Embed Code</label>
                            <div class="col-lg-10">
                                <textarea class="form-control uploadImage-group" id="embed_code" name="embed_code"  data-error=".embed_codeerror"><?php echo set_value('embed_code', (isset($data['embed_code']) ? $data['embed_code']:''  )); ?></textarea >
...
*/
    ...
    $("#formval").validate({
        ...
        upload_image: {
            require_from_group: [1, ".uploadImage-group"], 
            maxlength: {param: 0, depends: "#embed_code:filled"}
        },
        embed_code: {
            require_from_group: [1, ".uploadImage-group"], 
            maxlength: {param: 0, depends: ".upload_image:filled"}
        }
...
required:'Please select Testimonial Type',
                  ...
                  upload_image: "Please select either a image/video  or enter a embed code for youtube video.",
        embed_code: "Please enter either a embed code for youtube video or select  a image/video."
            },
            errorElement : 'div',

            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <?php if(isset($data['pressrelease_id'])) {      ?>
                            <span class="caption-subject font-brown bold uppercase">Edit  Testimonial Category</span>
                        <?php } else { ?>
                             <span class="caption-subject font-brown bold uppercase">Add  Testimonial Category</span>
                    <?php } ?>
                </div>    
                &nbsp;&nbsp;<span class="custpurple"><a class="brownsmall btn brown" href="<?php echo base_url('cms/category_testimonial/'); ?>">Back </a></span>
            </div>       
                    ...
                    <form id="formval" class="cmxform form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/category_testimonial/'); ?>"

            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <?php if(isset($id) && !empty($id)) { ?>
                        <span class="caption-subject font-brown bold uppercase">Edit Internship Statistics</span>
                    <?php } else { ?>
                         <span class="caption-subject font-brown bold uppercase">Add New Internship Statistics</span>
                   <?php } ?>
                </div>
                &nbsp;&nbsp;
                <span class="custpurple"><a class="sizebtn btn brown" href="<?php echo base_url('cms/internship_statistics/'); ?>">Back</a></span>
            </div>
            <div class="portlet-body form">
                <div class="form-body">
                    <form id="manage_form" class="cmxform form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group ">
                            <label for="placed" class="control-label col-lg-2">Number of Placed <span class="asterisk">*</span></label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="placed" name="placed" value="<?php echo set_value('placed', (isset($post_data['placed']) ? $post_data['placed'] : '')); ?>" required data-error=".placederror" maxlength="255">
                                <div class="placederror error_msg"><?php echo form_error('placed', '<label class="error">', '</label>'); ?></div>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a href="<?php echo base_url('cms/internship_statistics/') ?>" class="btn btn-default" type="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    $("#manage_form").validate({
        ...
        submitHandler: function(form){
                ...
                function check_graph(id,academic_year,branch) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: base_url+"cms/internship_statistics/ajax_check_graph",
                        async: false,

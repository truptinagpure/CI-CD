            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <!-- <form id="user_manipulate" class="cmxform form-horizontal tasi-form" method="post" action="<?php //echo $base_url.'edituser'.(isset($data['user_id'])?'/'.$data['user_id']:"") ?>"> -->
                        <form id="user_manipulate" class="cmxform form-horizontal tasi-form" method="post" action="<?php echo base_url().'admin/edituser'.(isset($data['user_id'])?'/'.$data['user_id']:"") ?>">
                    ...
                    //{
                        //$this->load->view('somaiya_general_admin/get_user_authtoken_using_patch');
                    //}
...
<script type="text/javascript">
    ...
    $.validator.addMethod("check_unique_username", function(value) {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"somaiya_general_admin/ajax_check_username",
            async: false,
    ...
    $.validator.addMethod("check_unique_email", function(value) {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"somaiya_general_admin/ajax_check_email",
            async: false,

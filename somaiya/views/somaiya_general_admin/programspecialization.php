                ...
                <div class="portlet light ">
                    <div class="portlet-title tabbable-line">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject font-brown bold uppercase"> <?=$title?></span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        ...
                                        <?php } ?> 
                                        <span class="custpurple">&nbsp;&nbsp;<a class="sizebtn btn brown" href="<?php echo base_url('admin/program/'.$institute); ?>">Back </a> </span>                                       
                                    </div>
                                </div>                                                         
                            </div>
                        </div>
                                ...
                                <?php foreach($data_list as $data){ ?>
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=$base_url?>programspecializationlang/program/<?=$data["sp_id"]?>" class="btn orange" title="<?=_l('Edit Contents',$this)?>"><i title="<?=_l('Edit Contents',$this)?>" class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>

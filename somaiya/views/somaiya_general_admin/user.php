            ...
            <form class="" action="">
                <div class="form-body">
                    <div class="portlet-body">   
                        <div class="row">
                            <div class="col-lg-12">
                                <span class="custorange"> <a href="<?php echo base_url();?>admin/edituser" class="sizebtn btn orange">Add New</a></span>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#user_send_email_form_submit').click(function(event){ 
            ...
            jQuery.ajax({
                type:"post",
                dataType:"json",
                url: '<?php echo base_url(); ?>admin/user_send_email_form_submit/',
    ...
    function send_email()
    {
        ...
        $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>admin/get_filtered_user_email_id/',
    ...
    function get_user_groups_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'admin/get_user_groups/',
            data: {},
    ...
    function get_user_institute_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'admin/get_user_institute_options/',
            data: {},
            success: function(response) {
    ...
    function get_all_username_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'admin/get_all_username_options/',
            data: {},
            success: function(response) {
    ...
    function get_all_user_fullname_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'admin/get_all_user_fullname_options/',
            data: {},
            success: function(response) {
    ...
    function get_all_user_email_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'admin/get_all_user_email_options/',
            data: {},
            success: function(response) {
    ...
    function initTable() {
        ...
        $('#dataTableId').bootstrapTable({
            ...
            url: base_url+'admin/user_ajax_list',
            method: 'GET',                
    ...
    function change_status(id, change_to) {
        ...
        if(id != '')
        {
            ...
            swal({
                ...
                if(result)
                {
                    window.location.href = base_url+'admin/user_change_status/'+id+'/'+change_to;
                }
            }, function(dismiss) {});
        }
    }
    ...
    function send_credential_to_user(user_id) {
        ...
        if(user_id != '')
        {
            swal({
                ...
                if(result)
                {
                    window.location.href = base_url+'admin/send_credential_to_user/'+user_id;
                }
            }, function(dismiss) {});
        }
    }

    ...
    <!-- BEGIN SAMPLE FORM PORTLET-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                &nbsp;&nbsp;<span class="custpurple"><a class="brownsmall btn brown" href="<?php echo $base_url.$page.(isset($data_type)?"/".$data_type:'').(isset($relation_id)?"/".$relation_id:""); ?>">Back </a></span>
            </div>
            <?php //echo "<pre>"; print_r($course_name);exit(); ?>
            <div class="portlet-body form" id="drag">
                    ...
                    <form id="user_manipulate" class="cmxform form-horizontal tasi-form" method="post" action="<?=$base_url.$page."_manipulate".(isset($data['contents_id'])?"/".$data['contents_id']:"")?>">
                        ...
                        ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-sm-10">
                                        ...
                                        ?>
                                                    <!-- <input value="<?=$data['language_id']?>" type="hidden" name="language_id" /><?=$data['language_name']?> -->
                                        <?php
                                                // }
                                            // }
                                        ?>
                        ...
                        <div class="form-group ">
                            <label for="title_name_2" class="control-label col-lg-2">Title Name 2<span class="asterisk">*</span></label>
                            <div class="col-lg-10">
                                <input class=" form-control" id="title_name_2" name="title_name_2" value="<?php if($data['title_name_2'] == '') { echo ucwords(strtolower($course_name['COURSE_NAME'])); } else { echo isset($data['title_name_2'])?$data['title_name_2']:''; } ?>" required="" data-error=".title_name_2error" type="text">
                                <div class="title_name_2error error_msg"><?php echo form_error('title_name_2', '<label class="error">', '</label>'); ?></div>
                            </div>
                        </div>
                        ...
                        <?php $user_id = $this->session->userdata['user_id']; 
                            if($user_id == 1 and $data['language_id'] == 1) {
                        ?>
...
function deletewidgets(image_id)
{
    ...
    { 
        ...
        if (answer)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/deletespecializationwidgets');?>",
...
$("#user_manipulate").validate({
        ...
        submitHandler: function(form){
                ...
                var formname                    = "programme_specialization";
                var check_result                = true;
                $('.languageerror').html('');

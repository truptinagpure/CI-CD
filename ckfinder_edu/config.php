...
$config['licenseName'] = 'SOMAIYA VIDYAVIHAR';
$config['licenseKey']  = 'QE9G-WUVN-EZRK-HFG6-V27Z-1379-RBWK';
...
//     'adapter'      => 'local',
//     'baseUrl'      => '/upload_file/',
//     'root'         => 'images20/', // Can be used to explicitly set the CKFinder user files directory.
//     'chmodFiles'   => 0777,
//     'chmodFolders' => 0777,
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://svv.somaiya.edu/upload_file/images20/',
    'root'         => '/var/www/html/somaiya.edu/upload_file/images20', // Can be used to explicitly$
    'chmodFiles'   => 0777,
    'chmodFolders' => 0777,
    'filesystemEncoding' => 'UTF-8',
);
